...
print("Nazywam si� Katarzyna Kielec. Aktualnie jestem na studiach magisterskich")
print("Wed�ug mnie chodzi w kodzie o to, by generowa� list� u�ytkownik�w o zbli�onych preferencjach innym u�ytkownikom, umo�liwia� rekomendowanie wykonawc�w nieocenionych innym u�ytkownikom")
